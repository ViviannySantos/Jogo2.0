...
public class Lobisomem implements Personagem {

	TipoPersonagem tipoPersonagem = TipoPersonagem.NAO_JOGAVEL;
	TipoClassePersonagem tipoClassePersonagem = TipoClassePersonagem.LOBISOMEM;
	...
	public void dados() {
		...
		tipoClassePersonagem.setCodigo(6);
		dados.setVida(250);
		dados.setAtaquePersonagem(45);
		dados.setDefesaPersonagem(40);
	...
	public void calcularBonusAtaque(String armaAtaque, String armaDefesa, String personagem) {
		...
		if(personagem.equals(TipoClassePersonagem.LOBISOMEM.getTipo())){
			
			System.out.println("-------B�nus de ataque do lobisomem-------");
	...
	public void calcularBonusDefesa(String armaAtaque, String armaDefesa, String personagem) {
		...
		if(personagem.equals(TipoClassePersonagem.LOBISOMEM.getTipo())){
			...
			System.out.println("-------B�nus de defesa do lobisomem-------");
			if(armaAtaque.equals(ModeloEquipamento.MACHADO.getTipo())){
