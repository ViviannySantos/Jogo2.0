...
public class Gladiador implements Personagem {

	TipoPersonagem tipoPersonagem = TipoPersonagem.JOGAVEL;
	TipoClassePersonagem tipoClassePersonagem = TipoClassePersonagem.GLADIADOR;
	...
	public void dados() {
		...
		tipoClassePersonagem.setCodigo(1);
		dados.setVida(200);
		dados.setAtaquePersonagem(20);
		dados.setDefesaPersonagem(15);
	...
	public void calcularBonusAtaque(String armaAtaque, String armaDefesa, String personagem) {
		...
		if(personagem.equals(TipoClassePersonagem.GLADIADOR.getTipo())){
			
			System.out.println("-------B�nus de ataque do gladiador-------");
	...
	public void calcularBonusDefesa(String armaAtaque, String armaDefesa, String personagem) {
		...
		if(personagem.equals(TipoClassePersonagem.GLADIADOR.getTipo())){
			...
			System.out.println("-------B�nus de defesa do gladiador-------");
			if(armaAtaque.equals(ModeloEquipamento.MACHADO.getTipo())){
