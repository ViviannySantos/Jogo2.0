...
public class Dragao implements Personagem {

	TipoPersonagem tipoPersonagem = TipoPersonagem.JOGAVEL;
	TipoClassePersonagem tipoClassePersonagem = TipoClassePersonagem.DRAGAO;
	...
	public void dados() {
		...
		tipoClassePersonagem.setCodigo(5);
		dados.setVida(400);
		dados.setAtaquePersonagem(90);
		dados.setDefesaPersonagem(80);
	...
	public void calcularBonusAtaque(String armaAtaque, String armaDefesa, String personagem) {
		...
		if(personagem.equals(TipoClassePersonagem.DRAGAO.getTipo())){
			
			System.out.println("-------B�nus de ataque do drag�o-------");
	...
	public void calcularBonusDefesa(String armaAtaque, String armaDefesa, String personagem) {
		...
		if(personagem.equals(TipoClassePersonagem.DRAGAO.getTipo())){
			...
			System.out.println("-------B�nus de defesa do drag�o-------");
			if(armaAtaque.equals(ModeloEquipamento.MACHADO.getTipo())){
