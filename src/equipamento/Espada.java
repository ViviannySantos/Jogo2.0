 ...
 *
 */
public class Espada extends EquipamentoPontos implements Equipamento {

	TipoEquipamento tipoEquipamento = TipoEquipamento.ARMA;
	ModeloEquipamento modeloEquipamento = ModeloEquipamento.ESPADA;
